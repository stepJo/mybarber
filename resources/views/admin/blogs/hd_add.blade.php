          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              ...
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Add Blog Header</li>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" action="{{ route('blogs.headers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="blog_hd_title" name="blog_hd_title" placeholder="Blog Header Title" value="{{ old('blog_hd_title') }}">
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" class="btn btn-primary">Add Blog Header</button>
